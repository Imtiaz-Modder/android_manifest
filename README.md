...
```bash
repo init -u https://github.com/Corvus-AOSP/android_manifest.git -b 12-test
```

# Or Initialize Shallow Clone #
```bash
repo init --depth=1 -u https://github.com/Corvus-AOSP/android_manifest.git -b 12-test
```
